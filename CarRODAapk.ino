...
void loop() {
  while (BT.available()) {
    char c = BT.read();
   /*
    if (c == '\n' || c == '\r') { // Verifique o final da mensagem
      //processVoiceCommand(readvoice);
      readvoice = ""; // Limpe o buffer
    } else {
      readvoice += c; // Anexar caractere ao buffer
    }*/
  }
...
void processVoiceCommand(String command) {
  command.trim(); // Remova qualquer espaço em branco extra

  if (command == "*para frente#") {
    andarParaFrente();
  } else if (command == "*para trás#") {
    andarParaTras();
    ...
    ficarParado();
  } else if (command == "*ligar o farol da frente#") {
    farolFrenteLigado();
  } else if (command == "*desligar o farol da frente#") {
    farolFrenteDesligado();
  } else if (command == "*ligar o farol de trás#") {
    farolTrasLigado();
  } else if (command == "*desligar o farol de trás#") {
    farolTrasDesligado();
  } else if (command == "*ligar a buzina#") {
    ligarBuzina();
  } else if (command == "*desligar a buzina#") {
    desligarBuzina();
  } else if (command == "*ligar os faróis#") {
    farolFrenteLigado();
    farolTrasLigado();
  } else if (command == "*desligar os faróis#") {
    farolFrenteDesligado();
    farolTrasDesligado();
  } else {
    ficarParado();
...
//    case 'W': farolFrenteLigado(); break;
//    case 'w': farolFrenteDesligado(); break;
//    case 'U': farolTrasLigado(); break;
//    case 'u': farolTrasDesligado(); break;
//    case 'V': ligarBuzina(); break;
//    case 'v': desligarBuzina(); break;
...
/*********************************************************/
/*Código antigo
carrinho bluetooth Arduino
Dev por "Michael" Trillobit3sGames
trillobit3s@gmail.com - estuartyy@gmail.com 
primeira atualização 05/02/2017
Ultima atualização 16/12/2023
